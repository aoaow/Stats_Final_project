...
- Independent Variables:
    - __comp_income__: A measure of relative income (household income divided by county income) which indicates economic status.
    - __pov__: Poverty level in the area, providing additional context on socio-economic conditions.
...
- Independent Variables:
    - __age__: Age of the deceased (continuous variable).
    - __urate__: Unemployment rate in the area, which could represent socio-economic stress.
